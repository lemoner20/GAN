...
G_PARAMS = [Weights, biases,
            Weights2, biases2,
            Weights3, biases3]  # G的参数
...
STD_T = tf.transpose(tf.expand_dims(STD, 0))
DATA = tf.concat(1, [MEAN_T, STD_T])
